...
class Friends extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('follower_id, following_id, suggestion', 'required'),
            array('suggestion', 'numerical', 'integerOnly'=>true),
            array('follower_id, following_id', 'length', 'max'=>100),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, follower_id, following_id, suggestion', 'safe', 'on'=>'search'),
        );
    }
