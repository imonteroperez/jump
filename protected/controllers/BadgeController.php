...
class BadgeController extends Controller
{
	...
	public function actionView($id)
	{
		if(isset($_GET["external"])){
			...
			echo '<h2><i>'.$model->title.'</i></h2>';
			echo '<p><strong>Description:</strong>'.$model->description;
			echo '<div id="raysDemoHolder">';
			echo '<div class="badge-detail"><img src="/jump/images/'.$model->img.'" id="raysLogo"></div>';
			echo '<div id="rays"></div></div>';
			exit;
		}
